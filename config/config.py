...
# 创建auto_send_bill_to_shpr文件夹
def create_auto_send_bill_to_shpr():
    # 创建auto_send_bill_to_shpr文件夹
    os.makedirs("conf/auto_send_bill_to_shpr")
...
def main():
    ...
    # 检查运行目录下有没有auto_send_bill_to_shpr文件夹。如果不存在生成一个文件夹
    if not os.path.exists("conf/auto_send_bill_to_shpr"):
        create_auto_send_bill_to_shpr()
